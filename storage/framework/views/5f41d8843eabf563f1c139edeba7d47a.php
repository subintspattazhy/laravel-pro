<div class="fixed-plugin">
      ...
      <div class="edit_profile">
        <form role = "form">
            <div class="input-group input-group-outline mb-3">
                ...
                <input type="text" class="form-control" id="name" value="<?php echo e(Auth::user()->name); ?>">
              </div>
              <div class="input-group input-group-outline mb-3">
  ...
  </script><?php /**PATH /var/www/html/laravel12.loc/resources/views/partials/profiledata.blade.php ENDPATH**/ ?>