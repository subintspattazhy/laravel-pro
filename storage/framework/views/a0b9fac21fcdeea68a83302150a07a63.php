        ...
        <div class="col-12">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                ...
                <h6 class="text-white text-capitalize ps-3">
                    <a href="<?php echo e(route('students.create')); ?>" class="add_class" title="Create New">
            ...
            <div class="card-body px-0 pb-2">
                ...
                <table class="table align-items-center mb-0" id="table-student">
                    <thead>
                    <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel12.loc/resources/views/students/index.blade.php ENDPATH**/ ?>